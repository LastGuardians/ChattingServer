...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(User_Login, success_),
  2,
  0,
  1,
  3,
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, 8, sizeof(User_Login)},
  { 12, 18, sizeof(Enter_Channel)},
  { 20, 26, sizeof(Change_Channel)},
  { 28, 34, sizeof(Channel_Chatting)},
  { 36, 42, sizeof(Create_Room)},
  { 44, 50, sizeof(Room_Chatting)},
  { 52, 59, sizeof(Enter_Room)},
  { 62, 68, sizeof(Leave_Room)},
  { 70, 77, sizeof(Notify_Exist_Room)},
  { 80, 85, sizeof(Notify_Enter_Room)},
  { 86, 91, sizeof(Notify_Leave_Room)},
  { 92, 100, sizeof(Room_List)},
};
...
void User_Login::SharedCtor() {
  ...
  user_id_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  password_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(&user_pid_, 0, reinterpret_cast<char*>(&success_) -
    reinterpret_cast<char*>(&user_pid_) + sizeof(success_));
}
...
// optional bool success = 4;
bool User_Login::has_success() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
void User_Login::set_has_success() {
  _has_bits_[0] |= 0x00000008u;
}
void User_Login::clear_has_success() {
  _has_bits_[0] &= ~0x00000008u;
}
void User_Login::clear_success() {
  success_ = false;
  clear_has_success();
}
bool User_Login::success() const {
  // @@protoc_insertion_point(field_get:Protocols.User_Login.success)
  return success_;
}
void User_Login::set_success(bool value) {
  set_has_success();
  success_ = value;
  // @@protoc_insertion_point(field_set:Protocols.User_Login.success)
}
