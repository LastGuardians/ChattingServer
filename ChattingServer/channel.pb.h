...
class channel_chatting : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Channel.channel_chatting) */ {
 public:
  channel_chatting();
  ...
  // @@protoc_insertion_point(class_scope:Channel.channel_chatting)
 private:
  void set_has_id();
  void clear_has_id();
  void set_has_target();
  ...
  friend struct  protobuf_channel_2eproto::TableStruct;
};
// ===================================================================
